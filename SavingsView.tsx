        ...
        <div className="flex flex-wrap items-center gap-3">
          {onResetBalances && (
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 bg-red-50 hover:bg-red-100 dark:bg-red-950/20 dark:hover:bg-red-950/40 text-red-600 dark:text-red-400 font-bold text-xs rounded-2xl transition-all border border-red-100 dark:border-red-900/30 active:scale-95"
            >
              <RotateCcw size={16} />
              Reset Saldo ke 0
            </button>
